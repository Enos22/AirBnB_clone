...
OBOBOB    """Unittests for testing to_dict method of the Review class."""

    def test_to_dict_type(self):
OBOBOB        self.assertTrue(dict, type(Review().to_dict()))

    def test_to_dict_contains_correct_keys(self):
        rv = Review()
OBOBOB        self.assertIn("id", rv.to_dict())
